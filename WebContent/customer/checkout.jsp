...
.order input[type="text"], input[type="tel"], input[type="email"], select
{
  width: 70%;
  height: 30px;
  padding: 5px 10px;
		...
		<div class="d-flex">
			<form action="<%=request.getContextPath()%>/order/insert" method="post">
				...
				<c:forEach var="c" items="${cartItems}">
					<input type="hidden" value="${c.cartItemId }" name="id" />
					<input type="hidden" value="${c.cart.cartId }" name="cartId" />
					<input type="hidden" value="${c.product.productId }" name="productId" />
				...
				<label> <span class="fname">First Name <span
				...
				</label> <label> <span>Country <span class="required">*</span></span>
					<select name="country">
				...
				</label> <label> <span>Address <span class="required">*</span></span>
				 ...
				 <label> <span>Postcode / ZIP <span class="required">*</span></span>
					<input type="text" name="postcode">
				</label> <label> <span>Phone <span class="required">*</span></span>
			...
			<div class="Yorder">
				...
				<table>
					...
					<tr>
						...
						<td>${c.product.productName } x ${c.quantity }(Qty)</td>
